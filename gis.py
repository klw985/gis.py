...
OPENCAGE_API_KEY = "c45010c61631462eac954223488bbd4b"  # Replace with your API key
...
with col1:
    address_input = st.text_area("Enter addresses or coordinates (one per line):")
